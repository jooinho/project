...
<div class="notice-home">
	...
	<div>
		<div>
			<ul>
				<li><a href="/notice/npo?ucode=${ucode}">신발</strong></a></li>
				<li><a href="/notice/npo2?ucode=${ucode}" style="color:black;"><strong>의류</strong></a></li>
...
function getList(){
	$.ajax({
		...
		data: {page:page,ncode1:"3",ncode2:"2"},
		dataType: "json",
